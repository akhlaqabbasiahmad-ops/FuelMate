...
if (-not $backendRunning) {
    ...
    Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'D:\my work place\PetrolMate\backend-dotnet'; Write-Host '🔧 Starting .NET Backend...' -ForegroundColor Green; .\START_BACKEND.ps1"
